...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      className={cn(
        "relative flex cursor-pointer select-none items-center gap-2 rounded-md px-2 py-1.5 text-sm outline-none transition-colors [&_svg:not([class*='size-'])]:size-4",
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      className={cn('z-50 min-w-[8rem] rounded-lg border border-border bg-popover p-1 shadow-lg', className)}
      {...props}
    />
  );
}
